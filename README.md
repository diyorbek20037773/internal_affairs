...
| **Qaror simulyatori (planshet)** | `/simulyator/qaror` | Bitta ssenariy (Q-01 «3-qavatdagi chaqiruv»), 5 xil vazifa: **sahna tahlili** (rasmda xavfni bosib belgilash), **tezkor qaror** (taymer), **ovozli javob** (mikrofon → STT → AI rubrika), **ustuvorlik** (tartiblash), **yozma raport** (AI rubrika). Ball (0–3) keyingi voqeani o'zgartiradi. Tanlovlarda **qonuniylik** va **mutanosiblik** (0–3); tezlik baholanmaydi. |
