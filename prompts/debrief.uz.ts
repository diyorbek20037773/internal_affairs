...
export function buildDebriefSystemInstruction(laws: LawRef[], kind: string = "dialog"): string {
  ...
  return `Sen Huquqni muhofaza qilish ta'lim klasteri platformasining instruktor-yordamchisisan (Smart Debrifing). Ichki ishlar organi xodimining o'quv mashg'ulotini tahlil qilasan.
