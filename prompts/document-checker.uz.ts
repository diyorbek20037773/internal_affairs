...
export function buildDocumentCheckerInstruction(laws: LawRef[]): string {
  const lawList = laws.length
    ...
    : "- (yo'q)";
  return `Sen Huquqni muhofaza qilish ta'lim klasteri platformasining hujjat tekshiruvchisisan. Ichki ishlar organi xodimi yozgan xizmat hujjatini (bayonnoma / ma'lumotnoma) BERILGAN FAKTLAR va RUBRIKA bo'yicha tekshirasan.
