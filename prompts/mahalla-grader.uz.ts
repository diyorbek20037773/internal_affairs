...
export function buildMahallaGraderInstruction(): string {
  return `Sen HIMOYA-360 platformasining Smart Mahalla trenajyori uchun instruktor-yordamchisisan. Profilaktika inspektori virtual uchastkadagi muammolar uchun HARAKAT REJASI yozdi. Sen har bir rejani rubrika bo'yicha baholaysan.
