...
Xatolar: ${st.mistakes?.join(" | ") || "-"}`;
  ...
  const systemInstruction = `Sen HIMOYA-360 yakuniy imtihon komissiyasining AI-yordamchisisan. Xodim "Bir kunlik xizmat" imtihonida to'liq ish kunini (hudud → nizoli fuqaro → xavfli vaziyat → hujjatlashtirish) mustaqil boshqardi. Butun kun bo'yicha BITTA xulosa ber.
