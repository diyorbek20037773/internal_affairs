...
export const tirMashinaBalon: TirScenario = {
  ...
  briefing: {
    uz: "Navbatchi: «Post oldida Nexia to'xtatildi, haydovchi mast, hujjat bermayapti. Bekatda odamlar bor. Sherik chap tomonda.»",
    ru: "Дежурный: «Перед постом остановлена Nexia, водитель нетрезв, документы не предъявляет. На остановке люди. Напарник слева.»",
    en: "Dispatcher: \"A Nexia has been stopped at the checkpoint, the driver is drunk and refuses to show documents. People at the bus stop. Partner on your left.\"",
  },
  difficulty: 3,
  ...
  actors: [
    { id: "car", role: "vehicle", kind: "vehicle", name: "Nexia (haydovchi Farhod)", weapon: "none", x: 0.8, z: -12, state: "parked", agitation: 70, compliance: 20, speed: 7,
...
export const tirOlomon: TirScenario = {
  ...
  briefing: {
    uz: "Navbatchi: «Chorsu yaqinidagi maydon, erkak pichoq bilan odamlarni qo'rqitmoqda, bir ayolni ushlab turibdi. Olomon ko'p. Sherik o'ng tomonda, kuch yo'lda.»",
    ru: "Дежурный: «Площадь у Чорсу, мужчина с ножом угрожает людям, удерживает женщину. Большая толпа. Напарник справа, подкрепление в пути.»",
    en: "Dispatcher: \"Square near Chorsu, a man with a knife is threatening people and holding a woman. Large crowd. Partner on your right, backup en route.\"",
  },
  difficulty: 3,
  ...
  actors: [
    { id: "s1", role: "suspect", kind: "human", name: "Erkak (pichoq)", weapon: "knife", x: 0.6, z: -5.6, state: "shouting", agitation: 78, compliance: 12, speed: 0.4, holds: "h1", shirt: "#3a3a3a",
    ...
    { id: "h1", role: "hostage", kind: "human", name: "Garovdagi ayol", weapon: "none", x: 0.1, z: -4.9, state: "held", shirt: "#d9c27a", gender: "f" },
...
export const tirBino: TirScenario = {
  ...
  briefing: {
    uz: "Navbatchi: «Biznes-markaz, 1-qavat, o'q ovozlari, bir necha jarohatlangan. Siz birinchi kirdingiz. Boshqa naryad ham binoda.»",
    ru: "Дежурный: «Бизнес-центр, 1-й этаж, выстрелы, несколько раненых. Вы вошли первым. В здании также другой наряд.»",
    en: "Dispatcher: \"Business centre, 1st floor, gunshots, several wounded. You are first in. Another unit is also in the building.\"",
  },
  difficulty: 3,
  ...
  actors: [
    ...
    { id: "g1", role: "suspect", kind: "human", name: "Otuvchi", weapon: "gun", x: 2.2, z: -7.5, state: "weapon_raised", agitation: 95, compliance: 0, aimSec: 2.5, hidden: true, keepsFiring: true, shirt: "#222",
      lines: { weapon_raised: ["Hamma yerga!"], aiming: ["Sen ham!"], dropping: [], kneeling: [] } },
    { id: "cop", role: "police", kind: "human", name: "Hamkasb (formada)", weapon: "gun", x: -5, z: -5.5, state: "walking", hidden: true, speed: 3, shirt: "#1c2a4a" },
    { id: "g2", role: "suspect", kind: "human", name: "Ikkinchi shaxs (eshik)", weapon: "gun", x: 2.4, z: -7, state: "hands_up", agitation: 60, compliance: 85, hidden: true, shirt: "#5a3a2a",
  ...
  script: [
    ...
    { atSec: 14.5, op: "move", actorId: "cop", x: 4, z: -6 },
  ...
  rubricHints: {
    ...
    natijadorlik: "Xodimga o'q tegmadimi (elektroshok), fuqarolar tegmadimi.",
  },
};
...
export const tirPichoqHovli: TirScenario = {
  ...
  briefing: {
    uz: "Navbatchi: «Bog'imaydon MFY, 7-uy. Erkak hovlida pichoq bilan baqiryapti, hech kimga hujum qilmagan. Sherik bilan yetib keldingiz.»",
    ru: "Дежурный: «МСГ Богимайдон, дом 7. Мужчина кричит во дворе с ножом, ни на кого не нападал. Вы прибыли с напарником.»",
    en: "Dispatcher: \"Bog'imaydon MFY, house 7. A man is shouting in the yard with a knife, has attacked no one. You have arrived with your partner.\"",
  },
  difficulty: 2,
  ...
  rules: { ...RULES },
  actors: [
    { id: "s1", role: "suspect", kind: "human", name: "Anvar", weapon: "knife", x: 0, z: -6.5, state: "shouting", agitation: 72, compliance: 15, speed: 0.45, shirt: "#8b2f2f",
...
export const tirShishaBekat: TirScenario = {
  ...
  briefing: {
    uz: "Navbatchi: «Bekatda mast shaxs o'tkinchilarga tegajoqlik qilmoqda, qo'lida shisha. Sherik mashinada.»",
    ru: "Дежурный: «На остановке нетрезвый пристаёт к прохожим, в руке бутылка. Напарник в машине.»",
    en: "Dispatcher: \"A drunk man at the bus stop is harassing passers-by, bottle in hand. Partner is in the car.\"",
  },
  difficulty: 1,
  ...
  actors: [
    { id: "s1", role: "suspect", kind: "human", name: "Sardor", weapon: "bottle", x: 0.5, z: -5.5, state: "shouting", agitation: 65, compliance: 20, speed: 0.4, shirt: "#3b4a8a",
...
export const tirPlateRack: TirScenario = {
  ...
  code: "TIR-M1",
  environment: "range",
  title: { uz: "Otish mahorati — plastina to'plami", ru: "Стрелковая подготовка — стойка с пластинами", en: "Marksmanship — plate rack" },
  brief: {
    uz: "6 plastina, 10 m. Vaqt birinchi o'qdan boshlanadi. Ball, tegish tezligi (tegish/soniya), o'qlar orasidagi vaqt. Qurolni chiqarib (F) plastinalarga oting.",
    ru: "6 пластин, 10 м. Таймер запускается с первого выстрела. Баллы, скорость поражения (попаданий/сек), интервалы между выстрелами. Извлеките оружие (F) и поразите пластины.",
    en: "6 plates at 10 m. Timer starts on the first shot. Score, hit factor (hits/second), split times. Draw your weapon (F) and shoot the plates.",
  },
  briefing: {
    uz: "Instruktor: «Plastina to'plami, 6 plastina, 10 metr. Qurolni chiqaring. Tayyor bo'lsangiz — birinchi o'q taymerni boshlaydi.»",
    ru: "Инструктор: «Стойка с пластинами, 6 пластин, 10 метров. Извлеките оружие. Когда будете готовы — первый выстрел запускает таймер.»",
    en: "Instructor: \"Plate rack, 6 plates, 10 metres. Draw your weapon. When ready, the first shot starts the timer.\"",
  },
  difficulty: 1,
