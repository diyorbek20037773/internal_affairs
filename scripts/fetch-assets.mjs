...
const files = {
  ...
  "hdri/entrance_hall_1k.hdr": `${PH}/HDRIs/hdr/1k/entrance_hall_1k.hdr`,
...
for (const n of ["overcast_industrial_courtyard", "modern_evening_street", "palermo_square", "abandoned_parking", "cinema_lobby", "entrance_hall", "large_corridor"]) {
